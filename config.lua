...
Config.Fuelsystem = "legacy" -- legacy (LegacyFuel) or lcfuel (lc_fuel)

-- Starting and ending locations for the job
Config.StartJobCoords = vector3(-1332.04, 43.97, 53.59)
Config.JobEndCoords = vector3(-1332.04, 43.97, 53.59)
...
-- Example marker positions for mowing tasks
Config.Markers = {
